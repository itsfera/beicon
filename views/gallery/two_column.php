        ...
        <ul class="gallery-tile-prev__list items_5">
            <? if(isset($galleryItems[0])){ ?>
                <li class="gallery-tile-prev__item" data-gallery="<?=$gallery["id"]?>">
                    <img src="<?=UPLOAD_DIR.ImageSizes::getResizesName($galleryItems[0]["url"], '1_1_516')?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                </li>
            <? } ?>
            <? if(isset($galleryItems[1])){ ?>
                <li class="gallery-tile-prev__item" data-gallery="<?=$gallery["id"]?>">
                    <img src="<?=UPLOAD_DIR.ImageSizes::getResizesName($galleryItems[1]["url"], '1_1_516')?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                </li>
            <? } ?>
            <? if(isset($galleryItems[2])){ ?>
                <li class="gallery-tile-prev__item" data-gallery="<?=$gallery["id"]?>">
                    <img src="<?=UPLOAD_DIR.ImageSizes::getResizesName($galleryItems[2]["url"], '16_9_830')?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                </li>
            <? } ?>
            <? if(isset($galleryItems[3])){ ?>
                <li class="gallery-tile-prev__item" data-gallery="<?=$gallery["id"]?>">
                    <img src="<?=UPLOAD_DIR.ImageSizes::getResizesName($galleryItems[3]["url"], '16_9_830')?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                </li>
            <? } ?>
            <? if(isset($galleryItems[4])){ ?>
                <li class="gallery-tile-prev__item" data-gallery="<?=$gallery["id"]?>">
                    <img src="<?=UPLOAD_DIR.ImageSizes::getResizesName($galleryItems[4]["url"], '16_9_830')?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                        ...
                        <? foreach ($gallery->items as $item) { ?>
                            <div class="swiper-slide">
                                <div class="gallery-fullscreen__image-container">
                                    <img src="/uploads/<?=$item["url"]?>" <?=(!empty($item['content']))?'alt="'.$item['content'].'"':''?>>
                                </div>
